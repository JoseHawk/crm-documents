package com.joselara.crmdocuments.configuration;
...
public class SwaggerConfiguration {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.joselara.crmdocuments"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "CRM Documents",
                "Documents microservice for the CRM Service",
                "API TOS",
